...
router.put('/:id', authenticate, requireWorkspaceRole('admin', 'id'), csrfProtection, validateBody(UpdateWorkspaceInput), controller.updateWorkspace);

// DELETE /api/workspaces/:id - delete workspace (owner only)
router.delete('/:id', authenticate, requireWorkspaceRole('owner', 'id'), csrfProtection, controller.deleteWorkspace);

// POST /api/workspaces/:id/leave - leave workspace (member/admin)
router.post('/:id/leave', authenticate, requireWorkspaceRole('member', 'id'), csrfProtection, controller.leaveWorkspace);
