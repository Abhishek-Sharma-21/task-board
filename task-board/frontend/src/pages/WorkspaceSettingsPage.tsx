...
export const WorkspaceSettingsPage: React.FC = () => {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    const result = ChangePasswordInput.safeParse({ currentPassword, newPassword, confirmPassword });
    if (!result.success) {
        ...
        <div className="bg-surface border border-border rounded-sm p-6 space-y-6">
          ...
          <div className="space-y-4 max-w-md">
            ...
            <button
              ...
              className="bg-primary hover:bg-primary-hover text-white text-xs font-mono font-bold uppercase px-4 py-2 rounded-sm transition-colors btn-press"
            >
          ...
          <div className="space-y-4 max-w-md border-t border-border pt-6">
            <div>
              <h4 className="text-xs font-mono font-bold uppercase text-text-muted">Change Password</h4>
              <p className="text-[10px] text-text-muted font-mono mt-1">Must be at least 8 characters.</p>
            </div>
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-input border border-border rounded-sm py-2 px-3 text-text-primary text-xs font-bold focus:outline-none focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              {passwordError && (
                <div className="p-2.5 bg-danger-light border border-danger-border rounded-sm text-xs font-mono text-danger font-bold">
                  {passwordError}
                </div>
              )}
              ...
              <button
                ...
                className="bg-primary hover:bg-primary-hover text-white text-xs font-mono font-bold uppercase px-4 py-2 rounded-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed btn-press"
              >
          ...
          <div className="pt-6 border-t border-border space-y-4">
            ...
            <form onSubmit={handleUpdateRetention} className="space-y-4 max-w-md">
              ...
              {isAdminOrOwner && (
                ...
                className="bg-primary hover:bg-primary-hover disabled:opacity-60 text-white font-mono text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-sm transition-colors flex items-center gap-2 btn-press"
                  >
                  ...
                  {completedTasks
                    ...
                    <tr key={t.id} className="hover:bg-surface-hover/50">
                      ...
                      <td className="py-3 px-4 text-text-secondary">
                        {t.assignees && t.assignees.length > 0 ? t.assignees.map((a: { id: string; name: string; email: string; avatarUrl?: string }) => a.name).join(', ') : 'Unassigned'}
                      </td>
                      <td className="py-3 px-4 text-right">
                        <button
